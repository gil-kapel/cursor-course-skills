...
```bash
asm add skill github:gil-kapel/cursor-course-skills/module-02-skills-and-agents/lesson-2.3-product-agent-prd/product-prd-agent
```

Or install all skills for a lesson using sparse checkout (see `bundle_module02_skills.py` in the main course repo).

The canonical public paths match the course repo lesson numbering (`2.2` through `2.10`).
